            ...
            <div class="panel-body">
                <form id="travellerForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="passport_no" placeholder="Enter Passport No" name="passport_id">
                    </div>
...
$("#btnSave").on("click", function(e) {
	$.ajax({
		type : "POST",
		url : "/admin/traveller/save",
		data : $("#travellerForm").serialize(),
		success : function(data, status) {
			$("#travellerForm").trigger('reset'); //reset the form
			$.alert({
				title : 'Saved!',
